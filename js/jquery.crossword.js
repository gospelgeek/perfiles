...
(function($) {
    $.fn.crossword = function(entryData) {
        ...
        */
        ...
        this.after('<div id="puzzle-clues"><div class="claves"><h2>Horizontal</h2><h2>Vertical</h2></div><div class="textClaves"><ol id="across"></ol><ol id="down"></ol></div></div>');
                    ...
                    for (var i = 0; i < entries[x - 1].length; ++i) {
                        ...
                        if ($(light).empty()) {
                            $(light)
                                ...
                                .append('<input id="fieldCross" maxlength="1" val="" type="text" tabindex="-1" />');
                        }
                    };
            ...
            checkAnswer: function(e) {
                ...
                if (valToCheck === currVal) {
                    ...
                    if (solved.length == 4) {
                        ...
                        var audio = new Audio('audio/wordFound.wav');
                        audio.volume = 0.5;
                        audio.play();
                    }
                    return;
